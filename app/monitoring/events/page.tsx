                ...
                reduce((accumulateValue, currentValue) =>
                    ...
                    <div className={styles.header_container}>
                      ...
                      <div className={styles.text_header}>
                        en
                        <div className={styles.bold}>{MapController.getDepartmentCount(EventsController.getMunicipalitiesCodes(tempEventData, "municipality_code"))}</div> departamentos y
